  ...
  return (
    <div className="h-screen">
      <div className="flex p-12 h-full items-center justify-center">
        <div>
          <h1 className="font-bold leading-tight mb-2 text-4xl text-gray-900" >Quand est-ce qu'on sera libre ?</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <input type="date"
              ...
              ref={register}
            />
            <input className="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-full w-24" type="submit" value="Voter" />
          </form>
        </div>
      </div>
      <div style={{zIndex: "-1"}} className="absolute top-0 left-0 width-auto height-auto overflow-hidden">
        <div
          style={{backgroundColor: "#ffa8ab", top: "-10px", left: "-20px"}}
          className="relative rounded-full w-56 h-56"
        />
      </div>
      <div style={{zIndex: "-1"}} className="absolute bottom-0 right-0 width-auto height-auto overflow-hidden" >
        <div
          style={{backgroundColor: "#6b4ee7", bottom: "-50px", right: "-100px", width: "325px", height: "325px"}}
          className="relative rounded-full"
        />
      </div>
      <div style={{ zIndex: "-1", bottom: "20%", left: "10%" }} className="absolute width-auto height-auto overflow-hidden">
        <div
